...
kChangelogs.en =
{
    ...
    "  - New Medtech #1 upgrade (Armory): medpacks heal 30 instantly and 20 over time.",
    "  - New Medtech #2 upgrade (Armory + Advanced Armory + Medtech #1): medpacks heal 40 instantly and 10 over time.",
...
kChangelogs.pt =
{
    ...
    "  - Nova melhoria Medtech #1 (Armory): os medpacks curam 30 na hora e 20 ao longo do tempo.",
    "  - Nova melhoria Medtech #2 (Armory + Advanced Armory + Medtech #1): os medpacks curam 40 na hora e 10 ao longo do tempo.",
...
kChangelogs.es =
{
    ...
    "  - Nueva mejora Medtech #1 (Armory): los medpacks curan 30 al instante y 20 a lo largo del tiempo.",
    "  - Nueva mejora Medtech #2 (Armory + Advanced Armory + Medtech #1): los medpacks curan 40 al instante y 10 a lo largo del tiempo.",
