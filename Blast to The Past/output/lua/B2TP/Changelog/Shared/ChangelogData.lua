...
kChangelogs.en =
{
    ...
    "",
    "## Round start",
    "  - Marines start with 1 IP, same as vanilla, instead of CBM's 2 IPs from 7 players, but now get +5 Tres on 7v7 and +10 Tres on 8v8 to compensate. This interpolates between 1 IP for 6v6 and the effective +1 IP for 10v10.",
    "",
    "## ARCs",
...
kChangelogs.pt =
{
    ...
    "",
    "## Início de round",
    "  - Os marines começam com 1 IP, igual ao vanilla, em vez dos 2 IPs do CBM a partir de 7 jogadores, mas agora recebem +5 Tres no 7v7 e +10 Tres no 8v8 para compensar. Isso interpola entre 1 IP para 6v6 e o efetivo +1 IP do 10v10.",
    "",
    "## ARCs",
...
kChangelogs.es =
{
    ...
    "",
    "## Inicio de ronda",
    "  - Los marines empiezan con 1 IP, igual que en vanilla, en vez de los 2 IPs de CBM desde 7 jugadores, pero ahora reciben +5 Tres en 7v7 y +10 Tres en 8v8 para compensar. Esto interpola entre 1 IP para 6v6 y el efectivo +1 IP del 10v10.",
    "",
    "## ARCs",
