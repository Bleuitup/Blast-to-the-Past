-- Teach the gorge drop ability about the two tunnel pseudo-structures.
-- Ported from ENSL CompMod (lua/CompMod/Weapons/Alien/DropStructureAbility.lua).
--
-- Negative activeStructure values address the tunnel abilities; positive values keep addressing
-- DropStructureAbility.kSupportedStructures exactly as vanilla does.

Script.Load("lua/B2TP/GorgeTunnels/Shared/TunnelEntranceAbility.lua")
Script.Load("lua/B2TP/GorgeTunnels/Shared/TunnelExitAbility.lua")
