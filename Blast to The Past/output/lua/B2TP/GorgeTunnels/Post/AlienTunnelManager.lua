-- Helpers the gorge tunnel menu needs to reason about networks. Ported from ENSL CompMod
-- (lua/CompMod/Entities/Alien/AlienTunnelManager.lua). Read-only additions; nothing here changes
-- how the commander's tunnels behave.
