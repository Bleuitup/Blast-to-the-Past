...
-- Thunderdome heart. White rather than yellow, because yellow is the vanilla color that turns red
...
--   2. Recolor every icon white after each Update. CBM 3.5 ignores the flag for the tint and
